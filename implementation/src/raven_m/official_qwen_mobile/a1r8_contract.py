"""Fail-closed A1-R8 contract."""
from __future__ import annotations
from contextlib import contextmanager
from pathlib import Path
from typing import Any,Iterator
from . import a1r6_contract as engine
from .a1r8_route_cycle_recovery_pending import EXPERIMENT_ID,MECHANISM_ID
...
PARENT_EVIDENCE_COMMIT="721af9efb1cba52cfa3db210a90eb9152e9e3699";CONFIG_SCHEMA="a1r8_route_cycle_recovery_pending_config_v1";OFFLINE_REPLAY_SCHEMA="a1r8_route_cycle_recovery_pending_offline_replay_v1";PREFLIGHT_SCHEMA="a1r8_rcrp_zero_generation_preflight_v1";LIVE_RECEIPT_SCHEMA="a1r8_rcrp_live_server_receipt_v1";RESULT_SCHEMA="a1r8_rcrp_result_v1";CHECKPOINT_SCHEMA="a1r8_rcrp_checkpoint_v1";REPOSITORY_ROOT=engine.REPOSITORY_ROOT
CONFIG_PATH=REPOSITORY_ROOT/"implementation/configs/a1r8_route_cycle_recovery_pending_hard_seed20260806.json";OFFLINE_REPLAY_PATH=REPOSITORY_ROOT/"evidence/a1r8/A1R8_RCRP_OFFLINE_REPLAY_REPORT.json";SOURCE_FREEZE_PATH=REPOSITORY_ROOT/"evidence/a1r8/A1R8_RCRP_SOURCE_FREEZE.json";PREFLIGHT_PATH=REPOSITORY_ROOT/"evidence/a1r8/A1R8_RCRP_ZERO_GENERATION_PREFLIGHT.json"
...
SOURCE_FILES=("protocols/A1R8_ROUTE_CYCLE_RECOVERY_PENDING_PREREG_2026-08-15.md","implementation/configs/a1r8_route_cycle_recovery_pending_hard_seed20260806.json","implementation/configs/androidworld_hard_v2_instances.json","implementation/src/raven_m/official_qwen_mobile/a1r8_route_cycle_recovery_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r7_grounding_recovery_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r6_goal_anchored_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r5_transition_invalidated_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r4_writer_resilient_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r3_stale_resistant_pending.py","implementation/src/raven_m/official_qwen_mobile/a1r8_contract.py","implementation/src/raven_m/official_qwen_mobile/a1r7_contract.py","implementation/src/raven_m/official_qwen_mobile/controller.py","implementation/src/raven_m/official_qwen_mobile/protocol.py","implementation/src/raven_m/official_qwen_mobile/working_memory.py","implementation/src/raven_m/models/vllm_client.py","implementation/src/raven_m/env/androidworld_adapter.py","implementation/src/raven_m/multi_framework_benchmark/task_instances.py","implementation/scripts/run_official_qwen_mobile.py","implementation/scripts/run_a1r8_rcrp.py","implementation/scripts/replay_a1r8_route_cycle_recovery_pending.py","implementation/scripts/preflight_a1r8_rcrp.py","implementation/scripts/qualify_a1r8_rcrp_server.py","implementation/scripts/start_a1r8_rcrp_server.sh","implementation/tests/official_qwen_mobile/test_a1r8_route_cycle_recovery_pending.py","implementation/tests/official_qwen_mobile/test_a1r8_contract.py","implementation/tests/official_qwen_mobile/test_a1r8_controller_integration.py","implementation/tests/official_qwen_mobile/test_a1r8_offline_replay.py","evidence/a1r8/A1R8_RCRP_OFFLINE_REPLAY_REPORT.json","evidence/a1r7/A1R7_GRPL_PRIMARY_GATE_RESULT_2026-08-15.json","evidence/a1r7/A1R7_GRPL_PRIMARY_GATE_RESULT_2026-08-15.md")
