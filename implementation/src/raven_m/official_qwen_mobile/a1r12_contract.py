"""Fail-closed A1-R12 composite contract."""
from __future__ import annotations
from contextlib import contextmanager
from pathlib import Path
from typing import Any,Iterator
from . import a1r6_contract as engine
from .a1r12_compacted_history_pending import EXPERIMENT_ID,MECHANISM_ID
...
PARENT_EVIDENCE_COMMIT="19d4c10257a877c8081de5acf31bd84237badef9";CONFIG_SCHEMA="a1r12_compacted_history_pending_config_v1";OFFLINE_REPLAY_SCHEMA="a1r12_compacted_history_pending_offline_replay_v1";PREFLIGHT_SCHEMA="a1r12_chp_zero_generation_preflight_v1";LIVE_RECEIPT_SCHEMA="a1r12_chp_live_server_receipt_v1";RESULT_SCHEMA="a1r12_chp_result_v1";CHECKPOINT_SCHEMA="a1r12_chp_checkpoint_v1";REPOSITORY_ROOT=engine.REPOSITORY_ROOT
CONFIG_PATH=REPOSITORY_ROOT/"implementation/configs/a1r12_compacted_history_pending_hard_seed20260806.json";OFFLINE_REPLAY_PATH=REPOSITORY_ROOT/"evidence/a1r12/A1R12_CHP_OFFLINE_REPLAY_REPORT.json";SOURCE_FREEZE_PATH=REPOSITORY_ROOT/"evidence/a1r12/A1R12_CHP_SOURCE_FREEZE.json";PREFLIGHT_PATH=REPOSITORY_ROOT/"evidence/a1r12/A1R12_CHP_ZERO_GENERATION_PREFLIGHT.json"
