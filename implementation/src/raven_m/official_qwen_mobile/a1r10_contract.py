"""Fail-closed A1-R10 composite contract."""
from __future__ import annotations
from contextlib import contextmanager
from pathlib import Path
from typing import Any,Iterator
from . import a1r6_contract as engine
from .a1r10_pre_action_calibrated_pending import EXPERIMENT_ID,MECHANISM_ID
...
PARENT_EVIDENCE_COMMIT="741bbc83b469bae34aec7eb44723d26a448b26e0";CONFIG_SCHEMA="a1r10_pre_action_calibrated_pending_config_v1";OFFLINE_REPLAY_SCHEMA="a1r10_pre_action_calibrated_pending_offline_replay_v1";PREFLIGHT_SCHEMA="a1r10_pacp_zero_generation_preflight_v1";LIVE_RECEIPT_SCHEMA="a1r10_pacp_live_server_receipt_v1";RESULT_SCHEMA="a1r10_pacp_result_v1";CHECKPOINT_SCHEMA="a1r10_pacp_checkpoint_v1";REPOSITORY_ROOT=engine.REPOSITORY_ROOT
CONFIG_PATH=REPOSITORY_ROOT/"implementation/configs/a1r10_pre_action_calibrated_pending_hard_seed20260806.json";OFFLINE_REPLAY_PATH=REPOSITORY_ROOT/"evidence/a1r10/A1R10_PACP_OFFLINE_REPLAY_REPORT.json";SOURCE_FREEZE_PATH=REPOSITORY_ROOT/"evidence/a1r10/A1R10_PACP_SOURCE_FREEZE.json";PREFLIGHT_PATH=REPOSITORY_ROOT/"evidence/a1r10/A1R10_PACP_ZERO_GENERATION_PREFLIGHT.json"
