...
"$ENV_DIR/bin/python" "$ROOT/implementation/scripts/preflight_a1r3_srpl.py" --validate-existing
...
print("A1-R3 preflight and model manifest accepted; starting zero-request server")
PY
