...
def main() -> int:
    ...
    command = [
        ...
        "--grpc-port", "8554",
        "--a1r13-evr",
        "--a1r13-preflight-report", str(ROOT / "evidence/a1r13/A1R13_EVR_ZERO_GENERATION_PREFLIGHT.json"),
        "--a1r13-launch-receipt", str(args.launch_receipt.resolve()),
        "--output-root", str(ROOT / "runs/a1r13_evr"),
    ]
