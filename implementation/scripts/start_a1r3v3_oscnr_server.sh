...
"$ENV_DIR/bin/python" "$ROOT/implementation/scripts/preflight_a1r3v3_oscnr.py" --validate-existing
...
print("A1-R3-v3 preflight and model manifest accepted; starting zero-request server")
PY
