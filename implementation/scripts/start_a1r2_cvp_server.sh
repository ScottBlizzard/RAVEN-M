...
"$ENV_DIR/bin/python" "$ROOT/implementation/scripts/preflight_a1r2_cvp.py" --validate-existing
...
print("A1-R2 preflight and model manifest accepted; starting zero-request server")
PY
