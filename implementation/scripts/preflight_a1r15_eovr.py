...
from implementation.scripts.replay_a1r15_explicit_observation_value_register import replay  # noqa: E402
...
def main() -> int:
    ...
    if args.validate_existing:
        ...
        return 0
    if not args.implementation_commit: parser.error("--implementation-commit is required")
    errors, checks = [], {}
    ...
    payload = {
        ...
        "fixture_content_sha256": fixture.get("content_sha256"), "checks": checks,
