...
"$ENV_DIR/bin/python" "$ROOT/implementation/scripts/preflight_a1r4_wrpl.py" --validate-existing
...
print("A1-R4 preflight and model manifest accepted; starting zero-request server")
PY
