...
from implementation.scripts.replay_a1r7_grounding_recovery_pending import replay
from raven_m.official_qwen_mobile import a1r7_contract as contract
from raven_m.official_qwen_mobile.a1r7_grounding_recovery_pending import GroundingRecoveryPendingMemory
base.contract=contract;base.TransitionInvalidatedPendingMemory=GroundingRecoveryPendingMemory;base.replay=replay
