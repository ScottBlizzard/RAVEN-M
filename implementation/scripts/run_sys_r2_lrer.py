#!/usr/bin/env python3
"""Print or execute the exact local SYS-R2-LRER runner invocation."""
...
def main() -> int:
    ...
    command = [
        ...
        str(ROOT / "evidence/sys_r2_lrer/SYS_R2_LRER_ZERO_GENERATION_PREFLIGHT.json"),
