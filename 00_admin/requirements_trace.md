...
| 多智能体记忆框架 | Planner/Executor/Memory/Critic、类型化 memory、证据路由与失效 | 代码、schema、append-only events、角色调用审计 | 已实现；v8–v10 的基础设施中断均保留，45 秒同请求恢复 smoke 已通过，G7 以不改方法的 v11 重跑 |
