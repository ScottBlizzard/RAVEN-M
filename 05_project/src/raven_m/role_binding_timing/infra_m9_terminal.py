"""Independent exactly-once terminal completion for INFRA-M9."""
...
def minimal_completion(*, run_id: str, status: str, first_edge: str | None) -> dict[str, Any]:
    return {
        "schema_version": "role_binding_timing.infra_m9.completion.v1",
        ...
        "claim_evidence": {
            ...
            "full_snapshot_ancestry_qualified": False,
            "runner_adb_authority_qualified": False,
    ...
    *, output_root: Path, journal: Any, run_id: str, status: str,
    ...
    if rich_completion is not None:
        try:
            ...
            passed = status == "PASS_12_OF_12_DEV"
            claims.update(
                authorization_view_separation_qualified=passed,
                full_snapshot_ancestry_qualified=passed,
                runner_adb_authority_qualified=passed,
    ...
    atomic_write_json(output_root / "terminal_writer_receipt.json", {
        "schema_version": "role_binding_timing.infra_m9.terminal_receipt.v1",
        "terminal_mode": mode,
