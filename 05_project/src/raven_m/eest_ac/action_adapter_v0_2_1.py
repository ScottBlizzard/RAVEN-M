"""Contract-audited adapter wrapper for EEST-AC v0.2.1."""
...
from raven_m.eest_ac.action_contract_v0_2_1 import action_schema, load_contract
from raven_m.env.androidworld_adapter import AndroidWorldAdapter, MappedAction


@dataclass(frozen=True)
class ContractMappedAction:
...
class EestActionAdapterV021:
    """Validate against the single contract before mapping or execution."""
    ...
    def map_action(
        ...
        *,
        ...
        return ContractMappedAction(dict(canonical), expected, mapped)
    ...
    def execute(self, env: Any, mapped: ContractMappedAction) -> None:
