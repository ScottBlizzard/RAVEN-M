"""Launch the isolated M0 Files smoke for the r52 candidate."""
...
SOURCE_COMMIT = "92d7be90e9627346d717ad68163f52de4948a8a2"
SOURCE_TAG = "protocol-v2-2-r52-local-candidate"
BASE_MANIFEST = (
...
GENERATED_MANIFEST = (
    ...
    "v2_2_r52_candidate.generated.json"
)
UPDATED_FREEZE_HASHES = {
    "05_project/src/raven_m/controller/episode_controller.py": (
        "c05cc5ad962382abba9680f30f3439a56067b9a040db2fbcc6d07cddd04673fd"
    ),
...
def build_candidate_manifest() -> Path:
    """Derive r52 without changing an immutable formal manifest."""
    manifest = json.loads(BASE_MANIFEST.read_text(encoding="utf-8"))
    manifest.update(
        {
            "schema_version": "protocol_v2_2_r52_candidate_smoke.v1",
            "manifest_id": "protocol_v2_2_seed20260729_r52_candidate",
            "source_tag": SOURCE_TAG,
            "source_commit": SOURCE_COMMIT,
            "suite_id": "nonhard_capability_v2_2_seed20260729_r52_candidate",
