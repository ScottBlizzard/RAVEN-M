"""Independent terminal finalizer for INFRA-M5."""
...
from raven_m.role_binding_timing.infra_m5_process_identity import finalize_m5_completion  # noqa: E402
...
def build_manifest(output_root: Path) -> dict[str, Any]:
    ...
    value = {"schema_version": "role_binding_timing.infra_m5.manifest.v1", "artifacts": artifacts}
...
def main() -> int:
    ...
    final = finalize_m5_completion(
        output_root=output_root, journal=journal, run_id=args.run_id,
    ...
    atomic_write_json(output_root / "terminal_validation.json", {
        "schema_version": "role_binding_timing.infra_m5.terminal_validation.v1",
