"""Launch the isolated M0 development smoke for the r43 candidate."""
...
SOURCE_COMMIT = "5e3af39f2d11423333dbe7510228628d3c95598f"
SOURCE_TAG = "protocol-v2-2-r43-local-candidate"
BASE_MANIFEST = (
...
GENERATED_MANIFEST = (
    ...
    "v2_2_r43_candidate.generated.json"
)
...
def build_candidate_manifest() -> Path:
    """Derive r43 without changing the immutable r39 manifest."""
    manifest = json.loads(BASE_MANIFEST.read_text(encoding="utf-8"))
    manifest.update(
        {
            "schema_version": "protocol_v2_2_r43_candidate_smoke.v1",
            "manifest_id": "protocol_v2_2_seed20260729_r43_candidate",
            "source_tag": SOURCE_TAG,
            "source_commit": SOURCE_COMMIT,
            "suite_id": "nonhard_capability_v2_2_seed20260729_r43_candidate",
