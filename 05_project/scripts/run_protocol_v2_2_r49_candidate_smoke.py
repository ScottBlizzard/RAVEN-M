"""Launch the isolated M0 Files smoke for the r49 candidate."""
...
SOURCE_COMMIT = "6ee10feb10786cdb710e5ea6a1710001b0cd24f5"
SOURCE_TAG = "protocol-v2-2-r49-local-candidate"
BASE_MANIFEST = (
...
GENERATED_MANIFEST = (
    ...
    "v2_2_r49_candidate.generated.json"
)
UPDATED_FREEZE_HASHES = {
    "05_project/src/raven_m/controller/episode_controller.py": (
        "6c86dc5629edc92796d693bcb2d0fa1c9a0d2c95d37bec13ed3c2af7cf116811"
    ),
    "05_project/src/raven_m/controller/protocol_v2_guard.py": (
        "78bfe9ea3123236b00785baf08a5c96d562a615d446b6f6f5dc6010ef56ec8c5"
    ),
...
def build_candidate_manifest() -> Path:
    """Derive r49 without changing an immutable formal manifest."""
    manifest = json.loads(BASE_MANIFEST.read_text(encoding="utf-8"))
    manifest.update(
        {
            "schema_version": "protocol_v2_2_r49_candidate_smoke.v1",
            "manifest_id": "protocol_v2_2_seed20260729_r49_candidate",
            "source_tag": SOURCE_TAG,
            "source_commit": SOURCE_COMMIT,
            "suite_id": "nonhard_capability_v2_2_seed20260729_r49_candidate",
