"""Preflight or run the isolated non-scored r58 H01 B3 smoke."""
...
SOURCE_COMMIT = "76887d8bff23f3babbc8de31b20e5fbb3ea17766"
SOURCE_TAG = "protocol-v2-2-r58-local-candidate"
...
GENERATED_MANIFEST = (
    ...
    "v2_2_r58_h01_candidate.generated.json"
)
UPDATED_FREEZE_HASHES = {
    ...
    "05_project/src/raven_m/controller/episode_controller.py": (
        "e771a365d95e00b12763b6e002c1f7a70c7c5ca4fc7c3ff7b4b3953d66cb9eab"
    ),
    "05_project/src/raven_m/controller/protocol_v2_guard.py": (
        "27a44019df8428688222109fadf86dcb0ac1393a7f35eda918cc1b6e811d202b"
    ),
}


def build_candidate_manifest() -> Path:
    """Derive r58 without changing an earlier formal or development result."""
    manifest = json.loads(BASE_MANIFEST.read_text(encoding="utf-8"))
    manifest.update(
        {
            "schema_version": "protocol_v2_2_gate_f_r58_candidate.v1",
            "manifest_id": "protocol_v2_2_gate_f_r58_candidate",
            "source_tag": SOURCE_TAG,
            "source_commit": SOURCE_COMMIT,
            "suite_id": "hard_micro_v2_2_seed20260730_r58_candidate",
        }
    )
    records_by_path = {
