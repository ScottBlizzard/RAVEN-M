"""Capture auditable stdout/stderr for the B2.9 pre-live offline gates."""
...
OUTPUT_ROOT = PROJECT_ROOT / "artifacts/role_binding_timing/phase_b2_9_androidenv_sidecar_offline_gates"
...
def main() -> int:
    ...
    commands = [
        (
            "focused",
            [str(PYTHON), "-m", "pytest", "tests/role_binding_timing/test_command_output_v0_2_9.py", "-q", "--color=no"],
            PROJECT_ROOT,
            180.0,
        ),
        (
    ...
    result = {
        "schema_version": "role_binding_timing.phase_b2_9.offline_gates.v0.2.9",
        "predecessor_evidence": {
            "path": "05_project/artifacts/role_binding_timing/phase_b2_8_androidenv_sidecar_diagnosis/diagnosis_completion.json",
            "status": "immutable_fail_settings_diagnostic"
        },
