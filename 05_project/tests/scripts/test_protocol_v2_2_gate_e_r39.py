...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r39.json"
)
R38_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r38.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r39.py"


def test_v2_2_r39_preserves_r38_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R38_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r39_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
