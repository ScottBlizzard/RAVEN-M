...
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r13.py"


def test_v2_2_r13_preserves_r12_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R12_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r13_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
