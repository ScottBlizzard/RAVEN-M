...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r32.json"
)
R31_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r31.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r32.py"


def test_v2_2_r32_preserves_r31_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R31_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r32_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
