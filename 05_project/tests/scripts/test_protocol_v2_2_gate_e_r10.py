...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r10.json"
)
R9_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r9.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r10.py"


def test_v2_2_r10_preserves_r9_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R9_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r10_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
