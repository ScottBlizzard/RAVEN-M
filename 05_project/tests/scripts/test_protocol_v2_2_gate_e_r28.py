...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r28.json"
)
R27_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r27.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r28.py"


def test_v2_2_r28_preserves_r27_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R27_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r28_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
