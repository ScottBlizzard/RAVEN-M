...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r21.json"
)
R20_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r20.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r21.py"


def test_v2_2_r21_preserves_r20_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R20_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r21_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
