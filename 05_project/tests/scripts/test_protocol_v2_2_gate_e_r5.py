...
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r5.py"


def test_v2_2_r5_is_prompt_only_and_preserves_r4_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R4_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r5_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
