...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r14.json"
)
R13_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r13.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r14.py"


def test_v2_2_r14_preserves_r13_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R13_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r14_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
