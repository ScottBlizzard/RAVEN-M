...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r8.json"
)
R7_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r7.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r8.py"


def test_v2_2_r8_preserves_r7_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R7_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r8_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
