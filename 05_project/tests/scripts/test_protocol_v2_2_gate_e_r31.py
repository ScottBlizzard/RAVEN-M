...
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r31.py"


def test_v2_2_r31_preserves_r30_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R30_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r31_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
