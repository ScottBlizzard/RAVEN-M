...
R16_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r16.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r17.py"


def test_v2_2_r17_preserves_r16_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R16_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r17_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
