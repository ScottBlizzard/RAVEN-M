...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r35.json"
)
R34_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r34.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r35.py"


def test_v2_2_r35_preserves_r34_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R34_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r35_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
