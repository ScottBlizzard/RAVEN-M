...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r22.json"
)
R21_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r21.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r22.py"


def test_v2_2_r22_preserves_r21_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R21_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r22_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
