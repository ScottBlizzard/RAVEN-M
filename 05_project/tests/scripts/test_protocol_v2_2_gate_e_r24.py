...
MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r24.json"
)
R23_MANIFEST = (
    ROOT / "05_project/configs/experiments/v2_2_capability_gate_r23.json"
)
WRAPPER = ROOT / "05_project/scripts/run_protocol_v2_2_gate_e_r24.py"


def test_v2_2_r24_preserves_r23_experiment_controls() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
    prior = json.loads(R23_MANIFEST.read_text(encoding="utf-8"))
...
def test_v2_2_r24_wrapper_and_manifest_share_source_freeze() -> None:
    value = json.loads(MANIFEST.read_text(encoding="utf-8"))
