...
WRAPPER = (
    ROOT / "05_project/scripts/run_protocol_v2_2_r60_h01_candidate_smoke.py"
)
...
def test_r60_wrapper_freezes_exact_candidate_source() -> None:
    ...
    assert tag.group(1) == "protocol-v2-2-r60-local-candidate"


def test_r60_candidate_preserves_historical_controls_and_freeze() -> None:
    wrapper = load_module(WRAPPER, "r60_h01_wrapper")
...
def test_r60_uses_only_isolated_non_scored_development_mode() -> None:
