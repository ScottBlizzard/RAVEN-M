...
2. [`presentation/GUI_Agent记忆机制探索_夏令营最终汇报_v8_评委叙事版.pdf`](presentation/GUI_Agent记忆机制探索_夏令营最终汇报_v8_评委叙事版.pdf)：按评委首次认知顺序重构的 12 页、15 分钟正式汇报；先讲做了什么和核心结果，再由 R15 自然推出新方法，最后回看旧实验并定位文献坐标。
...
8. 此时才正式介绍 L0-L6 信息机会链，再用它回看 R5-R12 的相同 0 分为何包含不同证据。
9. 最后与 MobileUse、MemGUI-Bench 比较分析尺度，并明确回顾性诊断已获支持、前瞻预测仍待验证。
